...
public class RollResult {
    ...
    /**
     * Creates a new roll result. The first step in the computation steps is expected to be the original roll
     * expression, the last step is expected to be the final result. All steps in between will be treated as
