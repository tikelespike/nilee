 ...
 * <p>
 * If the result for a given list of input values does change, the
 * implementing class should notify
 * its observers by using an {@link EventBus}, overriding the {@link UpdateSubject#addUpdateListener(EventListener)}
 * method to register listeners to the bus, and firing an {@link UpdateEvent} on a change.
 *
